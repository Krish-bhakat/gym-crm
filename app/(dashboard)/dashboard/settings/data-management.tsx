...
import { 
  ...
  CheckCircle2, Loader2, FileSpreadsheet
} from "lucide-react";
...
export function DataManagement() {
  ...
  return (
    <div className="space-y-6 p-1">
      ...
      {/* ================= SECTION 1: HEALTH VITALS (3 CARDS) ================= */}
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="shadow-sm">
          ...
          <CardContent>
            ...
            <Progress value={15} className="h-1.5 mt-2 bg-slate-100" />
          </CardContent>
        </Card>
      ...
      {/* ================= SECTION 2: IMPORT & EXPORT (HORIZONTAL) ================= */}
